...
\vspace{1cm}
{\Large \theentreprise \par}
\vfill
{\large \thedatedebut{} -- \thedatefin \par}
\vspace{0.5cm}
% Lien GitHub
\href{https://github.com/6rzrb5nscj-svg/La-maladie-de-Charcot-.git}{\large GitHub - La maladie de Charcot}
\vfill
{\large \membrea{} \par \membreb{} \par}
